...
1. Specify the **Subscription ID**. You can refer to [Guidelines to name a resource](../develop/write/stream.md#命名资源准则) to name a subscription.
...
::: tip
For more details about **ACK timeout** and **max unacked records**, please refer to [Attributes of a Subscription](../develop/receive/subscription.md#subscription-的属性).
:::
